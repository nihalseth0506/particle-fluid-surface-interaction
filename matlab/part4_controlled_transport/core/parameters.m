...
%params.E_adh = 1e-8;           % base adhesion energy [J]

%% --- Spatial adhesion (Part 4C) ---
params.E_adh_low  = 1e-10;     % weak adhesion (transport region)
params.E_adh_high = 5e-9;      % strong adhesion (capture zone)

params.x_target = 0.1;         % desired capture location [m]
params.x_capture_center = params.x_target;
params.x_capture_width  = 0.01; % capture zone half-width [m]
